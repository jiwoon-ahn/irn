...
class Cityscapes(VisionDataset):
    ...
    def __init__(
        ...
        if not isinstance(target_type, list):
            self.target_type = [target_type]
        [
            verify_str_arg(value, "target_type", ("instance", "semantic", "polygon", "color", "name"))
    ...
    def __getitem__(self, index: int) -> Tuple[Any, Any]:
        ...
        name, _ = os.path.splitext(os.path.basename(self.images[index]))
        targets: Any = []
...
class MultipleScalesTranform:

    def __init__(self, scales=(1.0,), img_normal=TorchvisionNormalize()) -> None:
        self.scales = scales
